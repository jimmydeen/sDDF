...
#include "include/sdma.h"
#include "include/sdma_script.h"
#include "include/nvic.h"
#include "include/sdma_regs.h"
/*******************************************************************************
 * Definitions
 ******************************************************************************/
/* This only works if the protection domain that this library is compiled into has the core controller
address mapped in */
